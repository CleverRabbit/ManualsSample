...
class RoutersControllerTest < ActionController::TestCase
  ...
  test "should create router" do
    assert_difference('Router.count') do
      post :create, router: { about: @router.about, about_lnk: @router.about_lnk, connection: @router.connection, connection_lnk: @router.connection_lnk }
    end
  ...
  test "should update router" do
    patch :update, id: @router, router: { about: @router.about, about_lnk: @router.about_lnk, connection: @router.connection, connection_lnk: @router.connection_lnk }
    assert_redirected_to router_path(assigns(:router))
  end
